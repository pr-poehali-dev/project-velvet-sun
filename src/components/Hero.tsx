  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Анна
          <span className="block text-sage italic">&amp; Михаил</span>
        </h1>

        <p
          className={`font-serif text-2xl md:text-3xl text-muted-foreground mb-4 transition-all duration-1000 delay-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          14 сентября 2025
        ...
        <p
          className={`text-sm tracking-[0.2em] uppercase text-terracotta mb-12 transition-all duration-1000 delay-800 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
        ...
        >
          ...
          <a
            href="#rsvp"
            className="inline-flex items-center gap-2 px-8 py-4 border border-border text-sm tracking-widest uppercase text-muted-foreground hover:text-foreground hover:border-foreground transition-all duration-500"
          >
            Подтвердить участие
          </a>
        </div>
